    ...
    public partial class frmReferencia : Form
    {
        ...
        private void frmReferencia_Load(object sender, EventArgs e)
        {
            ...
            foreach (ReferenciaDoc referencia in doc.Referencia)
            {
                ...
                if (referencia.TpoDocRef == "SET" || referencia.TpoDocRef == "1000")
                {
        ...
        {
            if (textBoxFolio.Text != "" && textBoxRazRef.Text != "" || labelIdDocRef.Text == "801")
            {
        ...
        private void cargaReferencia()
        {
            ...
            if (dataGridView1.Rows.Count != 0)
            {
                ...
                doc.estadoDte46 = checkBoxTipo46.Checked.ToString();
                doc.Referencia = referencias;
            }

        }

        private void comboBoxTipoDte_Validated(object sender, EventArgs e)
        {
            if (labelIdDocRef.Text == "61" || labelIdDocRef.Text == "46")
            {
                MessageBox.Show("Marque la opción si es \"FACTURA DE COMPRA\"");
                checkBoxTipo46.Visible = true;
                checkBoxTipo46.Select();
