   ...
   public class ClienteProductoModel
    {
       ...
       public DataTable getProdClientXCod(string rut, int idProd)
       {
           DataTable datatable = new DataTable();
           SqlConnection sqlcon = new SqlConnection();
           try
           {
               ...
               select.CommandText = "select producto.\"id\",producto.nombre,producto.\"codigoInt\", "
                                    ...
                                    + "and    clienteproducto.\"rutCliente\" = cliente.\"rutRecep\" "
                                    + "and    clienteproducto.\"rutCliente\" = '" + rut + "'"
                                    + "and    clienteproducto.\"idProducto\" = " + idProd + ";";
               OdbcDataReader reader = select.ExecuteReader();
               datatable.Load(reader);
        ...
        public void update(ClienteProductoModel cliProdModel)
        {
            SqlConnection sqlcon = new SqlConnection();
            try
            {
                ...
                OdbcCommand select = new OdbcCommand();
                select.Connection = conexion;
                select.CommandText = "UPDATE clienteproducto SET "
                                    + "\"precioNeto\"=" + cliProdModel.precioNeto + ","
                                    + "\"precioVenta\"=" + cliProdModel.precioVenta +" "
                                    + "WHERE \"rutCliente\" = '" + cliProdModel.rutCliente + "'"
                                    + "and \"idProducto\" = "+ cliProdModel.idProducto + ";";
                OdbcDataReader reader = select.ExecuteReader();
            }
            catch (Exception ex)
            {
